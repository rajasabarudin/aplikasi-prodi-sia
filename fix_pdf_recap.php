<?php
$file = file_get_contents('app/Http/Controllers/ObePortalController.php');
    ...
    public function pdfRecap($kriteria, $ppepp)
    {
        ...
        switch ($key) {
            ...
            case "C2_P1_PMB":
                ...
                $data = DB::table("pmb")->orderBy("tahun", "desc")->get();
                break;
            case "C2_P2_Mhs":
...
$start = strpos($file, 'public function pdfRecap');
$end = strpos($file, '}', strpos($file, 'return $pdf->stream', $start)) + 1;
$file = substr_replace($file, $new_pdf_recap, $start, $end - $start);

file_put_contents('app/Http/Controllers/ObePortalController.php', $file);
echo "pdfRecap function replaced with new LAM INFOKOM mappings.";
