...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h1 class="mb-0 fw-bold text-dark">Tambah Akun Baru</h1>
                <p class="text-muted mb-0">Silakan isi formulir di bawah ini untuk membuat akun baru.</p>
            </div>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #0f172a, #1e293b) !important;">
                <h5 class="card-title mb-0 fw-bold"><i class="bi bi-person-plus-fill me-2"></i>Formulir Akun Baru</h5>
            </div>
