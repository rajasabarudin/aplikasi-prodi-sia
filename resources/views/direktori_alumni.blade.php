                        ...
                        <div class="card-body p-4 text-center d-flex flex-column">
                            <div class="mb-3 position-relative mx-auto" style="width: 80px; height: 80px;">
                                @if($alumni->foto && \Storage::disk('public')->exists($alumni->foto))
                                    <img src="{{ asset('storage/' . $alumni->foto) }}" alt="{{ $alumni->nama }}" class="rounded-circle object-fit-cover shadow-sm w-100 h-100">
                                @else
                                    <div class="rounded-circle bg-light d-flex align-items-center justify-content-center shadow-sm w-100 h-100 text-primary fw-bold fs-3">
