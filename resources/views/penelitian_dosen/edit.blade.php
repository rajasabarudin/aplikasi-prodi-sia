...
@section('title', 'Edit Penelitian Dosen')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1>Edit Penelitian Dosen</h1>
...
@php
    $existingKodes = explode(', ', $penelitianDosen->kode_dosen);
    $existingNamas = explode(', ', $penelitianDosen->nama_dosen);
    $existingNims = $penelitianDosen->nim_mhs ? explode(', ', $penelitianDosen->nim_mhs) : [];
    $existingMhsNamas = $penelitianDosen->nama_mahasiswa ? explode(', ', $penelitianDosen->nama_mahasiswa) : [];
    $existingMitras = $penelitianDosen->anggota_mitra ? explode(', ', $penelitianDosen->anggota_mitra) : [];
@endphp

<form action="{{ route('penelitian-dosen.update', $penelitianDosen) }}" method="POST">
    @csrf
    @method('PUT')
            ...
            <div class="col-md-4 mb-3">
                ...
                <select name="ts_id" id="ts_id" class="form-select" required>
                    ...
                    @foreach ($tsList as $ts)
                        <option value="{{ $ts->id }}" {{ old('ts_id', $penelitianDosen->ts_id) == $ts->id ? 'selected' : '' }}>
                            {{ $ts->tahun_sekarang }}
                        </option>
                    @endforeach
                </select>
    ...
    <div class="card p-4 mb-4">
            ...
            <div id="mahasiswa-rows-container">
                @forelse ($existingNims as $index => $nim)
                    <div class="row g-2 mb-2 mahasiswa-row">
                        <div class="col-md-5">
                            <input type="text" name="nim_mhs[]" class="form-control input-nim-mhs" value="{{ $nim }}" data-route="{{ route('penelitian-dosen.get-mahasiswa', '') }}/" placeholder="Masukkan NIM...">
                        </div>
                        <div class="col-md-5">
        ...
        <div class="mb-0">
            ...
            <div id="mitra-rows-container">
                @forelse ($existingMitras as $mitra)
                    <div class="row g-2 mb-2 mitra-row">
                        <div class="col-md-10">
                            <input type="text" name="anggota_mitra[]" class="form-control" value="{{ $mitra }}" placeholder="Masukkan Nama Mitra...">
                        </div>
                        <div class="col-md-2">
    ...
    <div class="card p-4 mb-4">
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <input type="text" name="judul_penelitian" id="judul_penelitian" class="form-control" value="{{ old('judul_penelitian', $penelitianDosen->judul_penelitian) }}" required>
            </div>
            <div class="col-md-6 mb-3">
                ...
                <select name="jenis_jurnal" id="jenis_jurnal" class="form-select" required>
                    ...
                    <option value="Jurnal Nasional" {{ old('jenis_jurnal', $penelitianDosen->jenis_jurnal) == 'Jurnal Nasional' ? 'selected' : '' }}>Jurnal Nasional</option>
                    <option value="Jurnal Nasional Terakreditasi (SINTA)" {{ old('jenis_jurnal', $penelitianDosen->jenis_jurnal) == 'Jurnal Nasional Terakreditasi (SINTA)' ? 'selected' : '' }}>Jurnal Nasional Terakreditasi (SINTA)</option>
                    <option value="Jurnal Internasional" {{ old('jenis_jurnal', $penelitianDosen->jenis_jurnal) == 'Jurnal Internasional' ? 'selected' : '' }}>Jurnal Internasional</option>
                    <option value="Jurnal Internasional Bereputasi (Scopus/WoS)" {{ old('jenis_jurnal', $penelitianDosen->jenis_jurnal) == 'Jurnal Internasional Bereputasi (Scopus/WoS)' ? 'selected' : '' }}>Jurnal Internasional Bereputasi (Scopus/WoS)</option>
                </select>
            </div>
            <div class="col-md-6 mb-3">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="nama_jurnal" id="nama_jurnal" class="form-control" value="{{ old('nama_jurnal', $penelitianDosen->nama_jurnal) }}" required>
            </div>
            <div class="col-md-6 mb-3">
                <label for="link_jurnal" class="form-label">Link Jurnal</label>
                <input type="url" name="link_jurnal" id="link_jurnal" class="form-control" value="{{ old('link_jurnal', $penelitianDosen->link_jurnal) }}" placeholder="https://example.com/jurnal">
            </div>
        </div>
    </div>
    ...
    <div class="card p-4 mb-4">
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="url" name="berkas_sertifikat" id="berkas_sertifikat" class="form-control" value="{{ old('berkas_sertifikat', $penelitianDosen->berkas_sertifikat) }}" placeholder="https://example.com/sertifikat">
            </div>
            <div class="col-md-4 mb-3">
                <label for="berkas_paper" class="form-label">Link Paper</label>
                <input type="url" name="berkas_paper" id="berkas_paper" class="form-control" value="{{ old('berkas_paper', $penelitianDosen->berkas_paper) }}" placeholder="https://example.com/paper">
            </div>
            <div class="col-md-4 mb-3">
                <label for="proposal" class="form-label">Link Proposal</label>
                <input type="url" name="proposal" id="proposal" class="form-control" value="{{ old('proposal', $penelitianDosen->proposal) }}" placeholder="https://example.com/proposal">
            </div>
            <div class="col-md-6 mb-3">
                <label for="laporan" class="form-label">Link Laporan</label>
                <input type="url" name="laporan" id="laporan" class="form-control" value="{{ old('laporan', $penelitianDosen->laporan) }}" placeholder="https://example.com/laporan">
            </div>
            <div class="col-md-6 mb-3">
                <label for="lainnya" class="form-label">Link Lainnya</label>
                <input type="url" name="lainnya" id="lainnya" class="form-control" value="{{ old('lainnya', $penelitianDosen->lainnya) }}" placeholder="https://example.com/lainnya">
            </div>
        </div>
    </div>
