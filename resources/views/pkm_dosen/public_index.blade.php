    ...
    <div class="container position-relative z-1">
        <div class="row align-items-center">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <p class="mb-0">Silakan masukkan data Pengabdian kepada Masyarakat Anda di bawah ini. Cukup gunakan Kode Dosen Anda untuk mengisi data.</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-4" data-aos="fade-right" data-aos-delay="100">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4">
                    <h5 class="fw-bold mb-4"><i class="bi bi-plus-circle me-2 text-secondary"></i>Input Data Baru</h5>
                    <form action="{{ route('portal.pkm.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary" type="button" id="public-cek-dosen">Cek</button>
                            </div>
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-secondary text-white rounded-pill py-2 fw-bold" id="public-submit-btn" disabled>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                        <h5 class="fw-bold mb-0"><i class="bi bi-table me-2 text-secondary"></i>Daftar Pengabdian Masyarakat</h5>
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="fw-semibold">{{ Str::limit($item->tema_pkm, 50) }}</div>
                                        <div class="small text-muted"><i class="bi bi-building me-1"></i>{{ $item->mitra }}</div>
                                        <span class="badge bg-secondary bg-opacity-10 text-secondary rounded-pill px-2 mt-1" style="font-size: 0.7rem;">{{ $item->jenis_pkm }}</span>
                                    </td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="5" class="text-center py-4 text-muted">Belum ada data PkM yang disubmit.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
